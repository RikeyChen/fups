...
import { fetchUserFups, fetchDataFups, clearFups, removeDataFups, fetchLike, fetchFupsCount, clearFupCount } from '../../actions/fups_actions';
...
const mDTP = dispatch => ({
  ...
  clearFupsCount: () => dispatch(clearFupCount()),
